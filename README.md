...
| MiniMax | `MINIMAX_API_KEY` | Uses the [MiniMax API](https://www.minimax.io/) (OpenAI-compatible). Set `MINIMAX_API_REGION=cn` for the China endpoint. Supports MiniMax-M3 (default, 1M context, max output 128K), MiniMax-M2.7, and MiniMax-M2.7-highspeed. Temperature is auto-clamped to (0, 1] |
